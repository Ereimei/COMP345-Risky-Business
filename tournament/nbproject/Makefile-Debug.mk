...
${OBJECTDIR}/_ext/81a96254/card.o: ../cards/card.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/81a96254/card.o ../cards/card.cpp

${OBJECTDIR}/_ext/81a96254/deck.o: ../cards/deck.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/81a96254
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/81a96254/deck.o ../cards/deck.cpp
...
${OBJECTDIR}/_ext/d2a2ee96/Diepool.o: ../dice/Diepool.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2a2ee96/Diepool.o ../dice/Diepool.cpp

${OBJECTDIR}/_ext/d9388f64/GameStarter.o: ../gamestarter2/GameStarter.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d9388f64
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d9388f64/GameStarter.o ../gamestarter2/GameStarter.cpp
...
${OBJECTDIR}/_ext/de5414ba/mainGame.o: ../mainGame/mainGame.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/de5414ba/mainGame.o ../mainGame/mainGame.cpp

${OBJECTDIR}/_ext/511e288d/map.o: ../map/map.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/511e288d
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e288d/map.o ../map/map.cpp

${OBJECTDIR}/_ext/5d43fae0/Maploader.o: ../maploader/Maploader.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5d43fae0
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5d43fae0/Maploader.o ../maploader/Maploader.cpp

${OBJECTDIR}/_ext/8263846c/phase.o: ../phase/phase.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/8263846c
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/8263846c/phase.o ../phase/phase.cpp

${OBJECTDIR}/_ext/5e200f62/phaseObserver.o: ../phaseObserver/phaseObserver.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5e200f62
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5e200f62/phaseObserver.o ../phaseObserver/phaseObserver.cpp
...
${OBJECTDIR}/_ext/2ac0c52e/startup.o: ../startup/startup.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2ac0c52e/startup.o ../startup/startup.cpp
