...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/phaseobserver

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/phaseobserver: ${OBJECTFILES}
...
${OBJECTDIR}/phaseObserver.o: phaseObserver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/phaseObserver.o phaseObserver.cpp
